...
static void MX_TIM1_Init(void)
{
  ...
  sConfigOC.OCMode = TIM_OCMODE_PULSE_ON_COMPARE;
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GDRV_EN_GPIO_Port, GDRV_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : GDRV_EN_Pin */
  GPIO_InitStruct.Pin = GDRV_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GDRV_EN_GPIO_Port, &GPIO_InitStruct);
